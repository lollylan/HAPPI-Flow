...
export const matrixEntryInputSchema = z
    ...
    .refine((entry) => entry.minPerWeek === null ||
    entry.maxPerWeek === null ||
    entry.minPerWeek <= entry.maxPerWeek, { message: 'Das Minimum darf nicht über dem Maximum liegen.', path: ['minPerWeek'] });
...
export const userInputSchema = z.object({
    username: z
        ...
        .max(40)
        .regex(/^[a-zA-Z0-9._-]+$/, 'Erlaubt sind Buchstaben, Ziffern, Punkt, Bindestrich, Unterstrich.'),
